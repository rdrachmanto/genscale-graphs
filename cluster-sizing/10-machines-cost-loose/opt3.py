...
DEADLINE_VIOLATION_PENALTY = 10.0  # Penalty multiplier for exceeding deadline when optimizing cost
COST_VIOLATION_PENALTY = 10.0  # Penalty multiplier for exceeding cost cap when optimizing deadline
...
CONFIG = {
    ...
    "constraints": {
        ...
        "deadline": 1000,  # minutes - target deadline (soft constraint)
        "costCap": 400  # dollars - target cost cap (soft constraint)
    },
    ...
    "optimizationConfig": {
        "nIterations": 100,  # Total optimization iterations (increased from 200 for better convergence)
        "nInitialPoints": 10,  # Random exploration before optimization (matches dimensionality)
